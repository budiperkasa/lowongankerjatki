...
function jr_post_type() {
	...
	if(get_option($app_abbr.'_
	_tax_permalink')) $type_tax_base_url = get_option($app_abbr.'_job_type_tax_permalink'); else $type_tax_base_url = 'job-type';
	...
	if(get_option($app_abbr.'_job_cities_tax_permalink')) $cities_tax_base_url = get_option($app_abbr.'_job_cities_tax_permalink'); else $cities_tax_base_url = 'job-cities';	
...
function jr_edit_columns($columns){
	$columns = array(
		...
		'job_cities' => __('Cities', 'appthemes'),
