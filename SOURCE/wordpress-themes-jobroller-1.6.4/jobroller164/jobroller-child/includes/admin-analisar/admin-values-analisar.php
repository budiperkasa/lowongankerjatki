...
$options_settings = array(
	...
	array(  
		...
		array(  
		'name' => __('Enable Job Cities Location Field?','appthemes'),
		'desc' 		=> '',
		'tip' 		=> __('Enable or disable the Job Location(Cities)field in the job submission form.','appthemes'),
		'id' 		=> $app_abbr.'_enable_job_cities_field',
		'css' 		=> 'min-width:100px;',
		'std' 		=> 'no',
		'vis' 		=> '',
		'req' 		=> '',
	...
	array( 'type' => 'tab', 'tabname' => __('Advanced', 'appthemes') ),
		...
		array( 'name' => __('Custom Post Type & Taxonomy URLs', 'appthemes'),
				...
				array(  'name' => __('Job Cities Base URL', 'appthemes'),
                        'desc'=> sprintf( __("IMPORTANT: You must <a target='_blank' href='%s'>re-save your permalinks</a> for this change to take effect.",'appthemes'), 'options-permalink.php' ),
                        'tip' => __('This controls the base name of your cities urls. The default is job-cities and will look like this: http://www.yoursite.com/job-cities/citie-value/. Do not include any slashes. This should only be alpha and/or numeric values. You should not change this value once you have launched your site otherwise you risk breaking urls of other sites pointing to yours, etc.','appthemes'),
                        'id' => $app_abbr.'_job_cities_tax_permalink',
                        'css' => 'width:250px;',
                        'type' => 'text',
                        'req' => '',
                        'min' => '',
