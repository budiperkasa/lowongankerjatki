...
add_action( 'admin_init', 'jr_first_run', 9999 );
...
function jr_get_currency_symbol( $country_code = '', $keys = array( 'ASCII' ), $format = '%s' ) {
	...
	$currencies = array(
        ...
        'AUD' => array('name' => __('Australian Dollars', 'appthemes'), 'symbol' => 'A$', 'ASCII' => 'A&#36;'),
		'BRL' => array('name' => __('Brazilian Real', 'appthemes'), 'symbol' => 'R$', 'ASCII' => 'R&#36;'),
        'CAD' => array('name' => __('Canadian Dollars', 'appthemes'), 'symbol' => '$', 'ASCII' => '&#36;'),
        'CHF' => array('name' => __('Swiss Franc', 'appthemes'), 'symbol' => 'CHF', 'ASCII' => ''),
        'CZK' => array('name' => __('Czech Koruna', 'appthemes'), 'symbol' => 'Kč', 'ASCII' => ''),
        'DKK' => array('name' => __('Danish Krone', 'appthemes'), 'symbol' => 'Kr', 'ASCII' => ''),
        'HKD' => array('name' => __('Hong Kong Dollar', 'appthemes'), 'symbol' => '$', 'ASCII' => '&#36;'),
        'HUF' => array('name' => __('Hungarian Forint', 'appthemes'), 'symbol' => 'Ft', 'ASCII' => ''),
        'ILS' => array('name' => __('Israeli Shekel', 'appthemes'), 'symbol' => '₪', 'ASCII' => '&#8361;'),
        'JPY' => array('name' => __('Japanese Yen', 'appthemes'), 'symbol' => '¥', 'ASCII' => '&#165;'),
		'MYR' => array('name' => __('Malaysian Ringgits', 'appthemes'), 'symbol' => 'RM$', 'ASCII' => 'RM&#36;'),
        'MXN' => array('name' => __('Mexican Peso', 'appthemes'), 'symbol' => '$', 'ASCII' => '&#36;'),
        'NOK' => array('name' => __('Norwegian Krone', 'appthemes'), 'symbol' => 'Kr', 'ASCII' => ''),
        'NZD' => array('name' => __('New Zealand Dollar', 'appthemes'), 'symbol' => '$', 'ASCII' => '&#36;'),
        'PHP' => array('name' => __('Philippine Pesos', 'appthemes'), 'symbol' => '₱', 'ASCII' => ''),
        'PLN' => array('name' => __('Polish Zloty', 'appthemes'), 'symbol' => 'zł', 'ASCII' => 'z&#321;'),
        'SGD' => array('name' => __('Singapore Dollar', 'appthemes'), 'symbol' => '$', 'ASCII' => '&#36;'),
        'SEK' => array('name' => __('Swedish Krona', 'appthemes'), 'symbol' => 'kr', 'ASCII' => ''),
        'TWD' => array('name' => __('Taiwan New Dollars', 'appthemes'), 'symbol' => 'NT$', 'ASCII' => 'NT&#36;'),
        'THB' => array('name' => __('Thai Baht', 'appthemes'), 'symbol' => '฿', 'ASCII' => '&#3647;'),
    );
	...
	switch ($pack_type):
		case 'user':
			...
			if ($pack->pack_expires)
				$echo_pack_duration_expire = sprintf('%s <small>%s</small>',__('Usable before ', 'appthemes'), mysql2date(get_option('date_format'), $pack->pack_expires));
			else
				$echo_pack_duration_expire =  __('Unlimited', 'appthemes');
			...
			if ($pack->job_duration)
				$echo_pack_jobs .= sprintf(' (%s <small>%s</small>)', __('lasting ', 'appthemes'), $pack->job_duration.__(' days' ,'appthemes') );
			else
				$echo_pack_jobs .= sprintf(' (<small>%s</small>)', __('endless', 'appthemes') );
